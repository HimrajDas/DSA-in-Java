...
public class Stream {
    ...
    public static void main(String[] args) {
        // System.out.println(skip1("bcaadh"));
        // System.out.println(skipApple("bcdapplec"));
        System.out.println(skipAppNotApple("bcdappdfapple"));
    }
    ...
    static String skip1(String up) {
        ...
        char ch = up.charAt(0);
        if (ch == 'a') return skip1(up.substring(1));
        else return ch + skip1(up.substring(1));
    }
